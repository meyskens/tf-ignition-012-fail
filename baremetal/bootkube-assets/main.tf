...
data "ignition_file" "bootstrap_manifests__bootstrap_scheduler___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/bootstrap-manifests/bootstrap-scheduler.yaml",
    )
  }
}
...
data "ignition_file" "bootstrap_manifests__bootstrap_apiserver___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/bootstrap-manifests/bootstrap-apiserver.yaml",
    )
  }
}
...
data "ignition_file" "bootstrap_manifests__bootstrap_controller_manager___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/bootstrap-manifests/bootstrap-controller-manager.yaml",
    )
  }
}

data "ignition_file" "auth__pipeline_staging_config" {
  filesystem = "root"
  path       = "/opt/bootkube/assets/auth/tftest-config"
  mode       = "0644"
  count      = var.create_assets ? 1 : 0

  content {
    content = file("${path.module}/files/auth/tftest-config")
  }
}
...
data "ignition_file" "manifests__kube_scheduler_disruption___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests/kube-scheduler-disruption.yaml",
    )
  }
}
...
data "ignition_file" "manifests__kube_controller_manager_secret___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests/kube-controller-manager-secret.yaml",
    )
  }
}
...
data "ignition_file" "manifests__pod_checkpointer_role_binding___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests/pod-checkpointer-role-binding.yaml",
    )
  }
}
...
data "ignition_file" "manifests__kube_controller_manager_sa___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests/kube-controller-manager-sa.yaml",
    )
  }
}
...
data "ignition_file" "manifests__kube_proxy_role_binding___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests/kube-proxy-role-binding.yaml",
    )
  }
}
...
data "ignition_file" "manifests__kube_controller_manager_role_binding___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests/kube-controller-manager-role-binding.yaml",
    )
  }
}
...
data "ignition_file" "manifests__kube_controller_manager___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests/kube-controller-manager.yaml",
    )
  }
}
...
data "ignition_file" "manifests__kube_system_rbac_role_binding___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests/kube-system-rbac-role-binding.yaml",
    )
  }
}
...
data "ignition_file" "manifests__kube_controller_manager_disruption___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests/kube-controller-manager-disruption.yaml",
    )
  }
}
...
data "ignition_file" "manifests__coredns__service_account___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests/coredns/service-account.yaml",
    )
  }
}
...
data "ignition_file" "manifests__coredns__cluster_role_binding___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests/coredns/cluster-role-binding.yaml",
    )
  }
}
...
data "ignition_file" "manifests_networking__cluster_role___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests-networking/cluster-role.yaml",
    )
  }
}
...
data "ignition_file" "manifests_networking__bgppeers_crd___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests-networking/bgppeers-crd.yaml",
    )
  }
}
...
data "ignition_file" "manifests_networking__networkpolicies_crd___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests-networking/networkpolicies-crd.yaml",
    )
  }
}
...
data "ignition_file" "manifests_networking__globalnetworksets_crd___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests-networking/globalnetworksets-crd.yaml",
    )
  }
}
...
data "ignition_file" "manifests_networking__bgpconfigurations_crd___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests-networking/bgpconfigurations-crd.yaml",
    )
  }
}
...
data "ignition_file" "manifests_networking__clusterinformations_crd___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests-networking/clusterinformations-crd.yaml",
    )
  }
}
...
data "ignition_file" "manifests_networking__felixconfigurations_crd___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests-networking/felixconfigurations-crd.yaml",
    )
  }
}
...
data "ignition_file" "manifests_networking__hostendpoints_crd___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests-networking/hostendpoints-crd.yaml",
    )
  }
}
...
data "ignition_file" "manifests_networking__service_account___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests-networking/service-account.yaml",
    )
  }
}
...
data "ignition_file" "manifests_networking__cluster_role_binding___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests-networking/cluster-role-binding.yaml",
    )
  }
}
...
data "ignition_file" "manifests_networking__globalnetworkpolicies_crd___yaml" {
  ...
  content {
    content = file(
      "${path.module}/files/manifests-networking/globalnetworkpolicies-crd.yaml",
    )
  }
}
...
output "assets" {
  value = concat(
    ...
    data.ignition_file.auth__pipeline_staging_config.*.id,
